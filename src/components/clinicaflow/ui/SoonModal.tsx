  ...
  return (
    <Modal onClose={onClose} iconName="clock" iconBg="var(--surface-3)" iconColor="var(--muted)">
      ...
      <p className="muted" style={{ marginTop: 8 }}>
        Este módulo já faz parte da visão do produto, mas ainda não está disponível nesta fase. O
        foco atual é o fluxo <b style={{ color: 'var(--fg)' }}>WhatsApp → Agendamento</b> integrado
        ao Feegow.
      </p>
