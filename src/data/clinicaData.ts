...
const contacts: Record<number, Contact> = {
  ...
  1043: {
    ...
    iniciais: 'CF',
    cor: '#1ba59b',
    fone: '+55 11 98330-7744',
    email: 'carla.f@email.com',
    nascimento: '04/08/1985',
    cpf: '•••.•••.112-09',
    pacienteFeegow: 90233,
    convenio: 'Amil',
    plano: 'Amil 400',
    unidade: 'Centro',
    origem: 'WhatsApp',
  ...
  1044: {
    ...
    iniciais: 'JS',
    cor: '#e08332',
    fone: '+55 11 99110-5520',
    email: 'joao.santos@email.com',
    nascimento: '23/11/1972',
    cpf: '•••.•••.880-21',
    pacienteFeegow: 71004,
    convenio: 'Particular',
    plano: '—',
    unidade: 'Centro',
    origem: 'WhatsApp',
  ...
  1046: {
    ...
    iniciais: 'LB',
    cor: '#0a7d3f',
    fone: '+55 11 99650-1188',
    email: 'lucasb@email.com',
    nascimento: '17/06/1995',
    cpf: '•••.•••.450-77',
    pacienteFeegow: 66510,
    convenio: 'SulAmérica',
    plano: 'Especial 100',
    unidade: 'Jardins',
    origem: 'WhatsApp',
...
const conversations: Conversation[] = [
  {
    ...
    controlador: 'humano',
    preview: 'Pode ser quinta às 11? Mas queria confirmar com atendente',
    hora: '09:43',
    tempo: 'agora',
    naoLidas: 1,
    intencao: 'remarcar',
    ...
    mensagens: [
      ...
      {
        de: 'bot',
        txt: 'Claro, Marina! Encontrei sua consulta de Dermatologia em 03/06 às 10:00. Deseja remarcar essa?',
        t: '09:41',
        opts: ['Sim, remarcar essa', 'É outra consulta'],
      },
      { de: 'in', txt: 'Sim, essa mesma', t: '09:42' },
      {
        de: 'bot',
        txt: 'Perfeito. Tenho estes horários com a Dra. Helena (Dermatologia):',
        t: '09:42',
        opts: ['Qui 05/06 · 09:30', 'Qui 05/06 · 11:00', 'Sex 06/06 · 14:30'],
      },
  ...
  },
  {
    ...
    estado: 'em_conversa',
    controlador: 'ia',
    preview: 'Pode ser quinta de manhã 🙂',
    hora: '09:59',
    tempo: '12min',
    naoLidas: 0,
    intencao: 'agendar',
    ...
    mensagens: [
      ...
      {
        de: 'bot',
        txt: 'Oi, Carla! Tenho sim. Você prefere de manhã ou à tarde?',
        t: '09:58',
        opts: ['Manhã', 'Tarde'],
      },
      ...
      {
        de: 'bot',
        txt: 'Tenho estes horários de nutrição na quinta pela manhã:',
        t: '09:59',
        opts: ['Qui 05/06 · 08:30', 'Qui 05/06 · 09:15', 'Qui 05/06 · 10:00'],
      },
    ],
  },
  {
    ...
    estado: 'agendado',
    controlador: 'ia',
    preview: '✓ Agendado: Cardiologia 04/06 14:30',
    hora: '09:25',
    tempo: '20min',
    naoLidas: 0,
    intencao: 'agendar',
    ...
    mensagens: [
      ...
      {
        de: 'bot',
        txt: 'Bom dia, João! É particular ou por convênio?',
        t: '09:20',
        opts: ['Particular', 'Convênio'],
      },
      { de: 'in', txt: 'Particular', t: '09:21' },
      {
        de: 'bot',
        txt: 'Tenho amanhã 04/06 às 14:30 com Dr. Mendes (Cardiologia), valor R$ 380. Confirmo?',
        t: '09:22',
        opts: ['Confirmar', 'Ver outros horários'],
      },
      { de: 'in', txt: 'Confirmar', t: '09:24' },
      {
        de: 'bot',
        txt: '✅ Pronto, João! Consulta de Cardiologia confirmada para 04/06 às 14:30 com Dr. Mendes. Protocolo #339201.',
        t: '09:25',
      },
    ],
  },
  {
    ...
    estado: 'aguardando_atendente',
    controlador: 'humano',
    preview: 'Bom dia, gostaria de marcar um exame',
    hora: '09:14',
    tempo: '28min',
    naoLidas: 2,
    intencao: 'duvida',
    ...
    mensagens: [
      ...
      {
        de: 'bot',
        txt: 'Bom dia! Para te ajudar, qual exame você precisa? Se preferir, posso te transferir para a recepção.',
        t: '09:14',
        opts: ['Falar com atendente'],
      },
...
const modelos: Modelo[] = [
  {
    k: 'A',
    nome: 'Fluxo guiado',
    d: 'Menu e seletores (especialidade → profissional → data → horário), sem linguagem natural.',
    insp: 'Nina / WhatsApp Flows',
    tag: 'previsível, rígido',
  },
  {
    k: 'B',
    nome: 'Agente generativo',
    d: 'IA conversacional que entende linguagem aberta e responde dúvidas.',
    insp: 'Cloudia',
    tag: 'flexível, exige controle',
  },
  {
    k: 'C',
    nome: 'Híbrido',
    d: 'IA generativa na entrada/dúvidas + transição para fluxo estruturado na efetivação.',
    insp: 'Convergência de mercado',
    tag: 'recomendado',
    padrao: true,
  },
]
...
const intents: Intent[] = [
  {
    id: 'agendar',
    nome: 'Agendar',
    fluxo: 'Coleta guiada + disponibilidade Feegow + efetivação',
    on: true,
  },
  ...
  {
    id: 'duvida',
    nome: 'Dúvida / informação',
    fluxo: 'Resposta via base de conhecimento',
    on: true,
  },
